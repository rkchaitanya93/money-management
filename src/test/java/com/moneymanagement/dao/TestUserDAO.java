...
import com.moneymanagement.model.User;
...
public class TestUserDAO {
	...
	public void testGetUserById() throws CustomException {
		...
		assertTrue(u.getUserName().equals("person2"));
	}
	...
	public void testCreateUser() throws CustomException {
		User u = new User("person5", "person5@gmail.com");
		long id = h2DaoFactory.getUserDAO().insertUser(u);
		User uAfterInsert = h2DaoFactory.getUserDAO().getUserById(id);
		assertTrue(uAfterInsert.getUserName().equals("person5"));
		assertTrue(u.getEmailAddress().equals("person5@gmail.com"));
	}

	@Test
	public void testUpdateUser() throws CustomException {
		User u = new User(1L, "person1", "person1@gmail.com");
		int rowCount = h2DaoFactory.getUserDAO().updateUser(1L, u);
		// assert one row(user) updated
		assertTrue(rowCount == 1);
		assertTrue(h2DaoFactory.getUserDAO().getUserById(1L).getEmailAddress().equals("person1@gmail.com"));
	}
